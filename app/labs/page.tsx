...
import { ArrowLeft, Beaker, Code2, Cpu } from "lucide-react";
import { 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
          ...
          >
            <div className="mb-6">
              ...
              <h3 className="font-heading font-bold text-2xl mt-2 text-secondary tracking-[-0.02em]">BrandRecognizer</h3>
            </div>
