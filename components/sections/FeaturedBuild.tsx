...
export function FeaturedBuild() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 border-t border-border/50">
      <div className="max-w-7xl mx-auto px-6 space-y-32">
        ...
        <div className="space-y-16">
          <div className="text-center space-y-6">
            <h3 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-secondary tracking-[-0.03em]">System Architecture</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="font-bold text-xl">Analytics Warehouse</h4>
            ...
            >
              ...
              <h4 className="font-bold text-xl">Prediction Engine</h4>
            ...
            >
              ...
              <h4 className="font-bold text-xl">Real-time Caching</h4>
        ...
        <div className="grid md:grid-cols-[1fr_1fr] gap-16 items-center">
          <motion.div 
            ...
            className="space-y-8"
          >
            <h3 className="font-heading font-bold text-3xl md:text-5xl text-secondary">Feature Engineering</h3>
          ...
          >
            ...
            <div className="p-6 rounded-2xl bg-surface/50 border border-border/50 flex justify-between items-center group hover:bg-surface transition-colors">
              ...
              <span className="font-mono text-2xl font-bold text-primary">22,007 Matches</span>
            </div>
            <div className="p-6 rounded-2xl bg-surface/50 border border-border/50 flex justify-between items-center group hover:bg-surface transition-colors">
              <span className="text-muted">PvP Records</span>
              <span className="font-mono text-2xl font-bold text-primary">638K+</span>
            </div>
            <div className="p-6 rounded-2xl bg-surface/50 border border-border/50 flex justify-between items-center group hover:bg-surface transition-colors">
              <span className="text-muted">Inference Time</span>
              <span className="font-mono text-2xl font-bold text-accent">&lt;100ms</span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="space-y-16">
          <h3 className="font-heading font-bold text-3xl md:text-5xl text-center text-secondary">Dashboard Experience</h3>
