    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className={`relative group h-12 w-12 hover:w-32 rounded-full hover:rounded-xl transition-all duration-300 ease-out bg-surface border flex items-center justify-start px-3.5 py-3.5 overflow-hidden cursor-pointer hover:scale-105 ${
            starkMode 
        ...
        >
          ...
          <div className="flex items-center justify-start gap-2.5 select-none pointer-events-none w-full">
            ...
            <span className={`opacity-0 group-hover:opacity-100 max-w-0 group-hover:max-w-[80px] overflow-hidden transition-all duration-300 font-mono text-[10px] font-bold tracking-widest shrink-0 ${
